                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm font-medium">
                      You have already submitted your details. We will reach out to you in the next 24 hours.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex">
                <div className="flex-shrink-0">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M10 18a8 8 0 100-16 8 8 0 000 16zm-1.293-9.293a1 1 0 011.414-1.414L10 8.586l1.293-1.293a1 1 0 111.414 1.414L11.414 10l1.293 1.293a1 1 0 01-1.414 1.414L10 11.414l-1.293 1.293a1 1 0 01-1.414-1.414L8.586 10l-1.293-1.293z"
                      clipRule="evenodd"
                    />
                  </svg>
                </div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  <input
                    ...
                    className={`block w-full px-3 py-2 border ${
                      validationMsg.name ? 'border-red-300' : 'border-gray-300'
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  <input
                    ...
                    onChange={handleChange}
                    className={`block w-full px-3 py-2 border ${
                      validationMsg.email ? 'border-red-300' : 'border-gray-300'
                    } rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  <input
                    ...
                    onChange={handleChange}
                    className={`block w-full px-3 py-2 border ${
                      validationMsg.phone ? 'border-red-300' : 'border-gray-300'
                    } rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
